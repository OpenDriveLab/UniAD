...
# Xiao Luo
# OccHead contains many module in densehead, but not recorded
...
class OccHead(BaseModule):
    ...
    def forward(self, x, ins_query):
        with torch.profiler.record_function("OccHead-forward"):
    ...
    def forward_train(
        ...
        with torch.profiler.record_function("OccHead-forward_train"):
    ...
    def forward_test(
        ...
        with torch.profiler.record_function("OccHead-forward_test"):
